...
path = "C:/Users/HP/Documents/GitHub/Plasma-simulations-thesis-/Corrección 1/beamplasmagraficas/"
graf = (np.pi/pa.dt/16)
t = 0
p = 0
e = 1
...
while  t < pa.time_step*pa.dt:
    if t == 0:
        ...
        plt.xlabel("x")
        plt.ylabel("v")
        plt.title("Inestabilidad Beam-plasma" + "  tiempo =" + str(round(t,2)))
        plt.savefig(path + "beamplasma" + str(step) + ".png")
